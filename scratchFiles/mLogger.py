...
async def on_message(message):
    ...
    print(
        Fore.GREEN
        + f"Message from {message.author} in channel {message.channel}: {message.content}"
    )
...
async def on_message_delete(message):
    ...
    print(
        Fore.RED
        + f"Message deleted from {message.author} in channel {message.channel}: {message.content}"
    )
